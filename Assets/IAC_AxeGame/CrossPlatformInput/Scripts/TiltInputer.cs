...
namespace IACFPSController.CrossPlatformInput
{
    ...
    public class TiltInputer : MonoBehaviour
    {
        ...
        private CrossPlatformInputManage.VirtualAxis m_SteerAxis;
        ...
        private void OnEnable()
        {
            ...
            {
                m_SteerAxis = new CrossPlatformInputManage.VirtualAxis(mapping.axisName);
                CrossPlatformInputManage.RegisterVirtualAxis(m_SteerAxis);
            }
        }
        ...
        private void Update()
        {
            ...
            switch (mapping.type)
            {
                ...
                case AxisMapping.MappingType.MousePositionX:
                    CrossPlatformInputManage.SetVirtualMousePositionX(axisValue*Screen.width);
                    break;
                case AxisMapping.MappingType.MousePositionY:
                    CrossPlatformInputManage.SetVirtualMousePositionY(axisValue*Screen.width);
                    break;
                case AxisMapping.MappingType.MousePositionZ:
                    CrossPlatformInputManage.SetVirtualMousePositionZ(axisValue*Screen.width);
                    break;
            }
        }
...
namespace IACFPSController.CrossPlatformInput.Inspector
{
#if UNITY_EDITOR
    [CustomPropertyDrawer(typeof (TiltInputer.AxisMapping))]
